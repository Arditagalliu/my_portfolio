...
var i = 0;
var text2 = 'rdit Agalliu';
var speed = 200;
$("html").on('load', typeWriter());
function typeWriter() {
    alert
  if (i < text2.length) {
    document.getElementById("name_container").innerHTML += text2.charAt(i);
    i++;
...
$("#job2").hover(
	...
	function(){
        this.innerHTML ="I'm a Web Developer!"
    }
);


var text = ' Junior Web Developer';

var chars = text.split('');
var container = document.getElementsByClassName("job");
var j = 0;
setInterval(function () {
    if (j < chars.length) {
        container[0].innerHTML += chars[j++];
    } else {
        j = 0;
        container[0].innerHTML = ">_";
    }
}, 200);
